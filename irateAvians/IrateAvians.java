        ...
        while (!winConditionFulfilled) {
            ...
            //BIRD PHYSICS
                ...
                for (int i = 0; i < numTargets; i++) {
                    ...
                    double birdTgX = birdPosX - targetXs[i];
                    double birdTgY = birdPosY - targetYs[i];
                    double birdTgRad = birdRadius + targetRadii[i];
                    if ((Math.sqrt(birdTgX * birdTgX) + (birdTgY * birdTgY)) <= 
                        birdTgRad)
                    {
                        targetsHit[i] = true; 
                    }
